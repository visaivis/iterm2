# Generated by Powerlevel10k configuration wizard on 2025-12-08 at 09:52 PST.
...
() {
  ...
  # Using nerdfont-v3 to enable full Nerd Font icon support (requires MesloLGS NF or similar).
  ...
  # Branch icon. Using Nerd Font git-branch icon.
